...
namespace tb_1
{
    ...
    ClkDiv::ClkDiv(sc_module_name arg_nm)
    {
    ...
    tb::tb(sc_module_name arg_nm)
    {
        ...
        this->drv_path    = "./pydrv1.py";
        this->drv_handler = "dot3_by_len";
        this->drv_request = "{\"size\":70}";
        this->msg         = unique_ptr<Msg>(new Msg(this->name()));
        this->drv         = new DrvClient(this->drv_path);

        this->i_clk = new Clk<bool>("i_clk", (this->clk_freq_hz * 8.0), 0.5, 1.0, SC_NS, true);
        this->i_div = new ClkDiv("i_div");
        this->i_uut = new Vuut_1_top("i_uut");
        ...
        this->i_div->clk_o  ( div_clk  );
        this->i_div->stb_o  ( div_stb  );
        this->i_div->clk_i  ( tb_clk   );

        this->i_uut->bclk_i ( tb_clk   );
        this->i_uut->bstb_i ( div_stb  );
        this->i_uut->pclk_i ( div_clk  );
